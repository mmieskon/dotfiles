...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "0", "1", "2", "3", "4", "5", "6" }, s, awful.layout.layouts[1])
...
local move_to_screen = function(i)
...
for i = 1, 7 do
    globalkeys = gears.table.join(globalkeys,
        ...
        -- Toggle tag display.
        awful.key({ modkey, "Control" }, "#" .. i + 9 + 19,
                  function ()
                      local screen = awful.screen.focused()
                      local tag = screen.tags[i]
                      if tag then
        ...
        awful.key({ modkey, "Control", "Shift" }, "#" .. i + 9 + 19,
                  function ()
                      if client.focus then
                          local tag = client.focus.screen.tags[i]
                          if tag then
