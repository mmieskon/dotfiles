...
alias fastfetch='fastfetch -s "OS:Kernel:Packages:Separator:Display:GPU:WM:Separator:Terminal:Shell:Separator:Host:CPU:Disk:Memory:Break:Colors"'
[[ $(tty) != /dev/tty* ]] && \clear && fastfetch
